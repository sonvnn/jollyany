	...
	if($params -> get('show_cat_vote', 1)){
        ...
        <span class="rating">
            <a href="javascript:;"
               ...
               class="rating-item tp tp-star<?php echo (($count > 4)?' voted':'')?>">
                ...
                <?php }?>
                   ...
                   class="rating-item tp tp-star<?php echo (($count > 3)?' voted':'')?>">
                ...
                <?php }?>
                   ...
                   class="rating-item tp tp-star<?php echo (($count > 2)?' voted':'')?>">
                ...
                <?php }?>
                   ...
                   class="rating-item tp tp-star<?php echo (($count > 1)?' voted':'')?>">
                ...
                <?php }?>
                   ...
                   class="rating-item tp tp-star<?php echo (($count > 0)?' voted':'')?>">
