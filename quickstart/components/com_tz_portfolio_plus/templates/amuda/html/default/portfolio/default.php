...
$input      = $app -> input;
$params = &$this -> params;
$doc -> addStyleSheet(TZ_Portfolio_PlusUri::base(true).'/templates/amuda/css/jquery.fancybox.min.css');
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/amuda/js/jquery.fancybox.min.js');
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/amuda/js/lightbox.js');
...
<?php if($this -> items):?>
    ...
    $params = &$this -> params;
?>
<div id="tpPortfolio" class="tplAmuda <?php echo $this->pageclass_sfx;?>">
