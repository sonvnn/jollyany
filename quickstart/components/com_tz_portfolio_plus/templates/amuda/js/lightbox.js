...
var amuda_lightbox  =   function () {
    if(jQuery('.tplAmuda').length > 0) {
        jQuery('.tplAmuda .amudaLink').on('click', function(event) {
            event.preventDefault();
            var image       = [];
            var $pic        = jQuery('.tplAmuda');
            ...
            var getItems = function() {
                ...
                $el.each(function() {
                    ...
                    jQuery(this).find('a.amudaLink').each(function () {
