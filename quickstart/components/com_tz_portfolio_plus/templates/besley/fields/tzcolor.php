...
class JFormFieldTZColor extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        if (!self::$initialised)
        {
            JFactory::getDocument() -> addStyleSheet(JUri::root().'/administrator/components/com_tz_portfolio_plus/models/fields/css/spectrum.css');
            JFactory::getDocument() -> addScript(JUri::root().'/administrator/components/com_tz_portfolio_plus/models/fields/js/spectrum.js');
