...
$doc -> addStyleSheet(TZ_Portfolio_PlusUri::base(true). '/bootstrap/css/bootstrap.min.css', array('version' => '3.3.6'));
...
(function($){
    ...
    $(document).ready(function(){
        ...
        $(document).ready(function(){
            ...
            $(".hasPopover").on("mouseleave", function () {
                $(this).show();
            });
        });
    });
...
<div class="tpEdit<?php echo $this->pageclass_sfx; ?> tzpp_bootstrap3">
