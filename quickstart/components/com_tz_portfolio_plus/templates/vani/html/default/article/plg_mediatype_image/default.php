...
?>
    ...
    <div class="tpImage main-image" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
            <?php if(isset($image -> url_detail) && trim($image -> url_detail)): ?>
                <a data-fancybox="gallery" href="<?php echo $image -> url_detail;?>"><div class="overlay"><i class="tps tp-search"></i></div></a>
            ...
            <?php  else : ?>
                <a data-fancybox="gallery" href="<?php echo $image -> url;?>"><div class="overlay"><i class="tps tp-search"></i></div></a>
