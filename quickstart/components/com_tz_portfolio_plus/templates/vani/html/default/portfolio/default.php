...
//    .tplVani .element .TzInner .TzPortfolioDescription {background-color: '.$tplParams->get('backgroundcolor').';}
//');
?>
...
?>
<div id="tpPortfolio" class="<?php echo $bootstrapClass;?>tpPortfolio tplVani <?php echo $this->pageclass_sfx;?>">
    ...
    <div id="portfolio" class="super-list variable-sizes clearfix" style="margin: 0 -<?php echo $tplParams->get('padding'); ?>"
