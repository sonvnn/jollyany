...
?>
    <?php foreach($this -> items as $i => $item):
        ...
        $type           =   $params -> get('tpl_vani_type','standard');
        $title_pos      =   $params -> get('tpl_vani_title_position','bottom-left');
    ?>
<div id="tzelement<?php echo $item -> id;?>"
     ...
     class="element <?php echo $type.' '.$class.$tzItemClass.$tzItemFeatureClass;?>"
        ...
        <div class="tpThumbnail <?php echo $title_pos; ?>"<?php echo trim($tplParams->get('padding')) ? 'style="top:'.$tplParams->get('padding').';left:'.$tplParams->get('padding').';right:'.$tplParams->get('padding').';bottom:'.$tplParams->get('padding').';"' : ''; ?>>
            ...
            if(!isset($item -> mediatypes) || (isset($item -> mediatypes) && !in_array($item -> type,$item -> mediatypes))):
                ...
                <div class="TzPortfolioDescription">
                    ...
                    ?>
                    <?php
                    if(!$params -> get('show_cat_intro',0)) {
                    ...
                    <?php  if ($params->get('show_cat_intro',0) AND !empty($item -> introtext)) :?>
                        <div class="TzPortfolioIntrotext" itemprop="description">
                            <?php echo JHtmlString::truncate($item -> introtext, $tplParams->get('introtext_cuttext', 50)) ;?>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($params -> get('show_cat_readmore',0)):?>
