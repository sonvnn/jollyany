...
if ($list):
    ?>
    <div id="TzContent<?php echo $module->id; ?>" class="tz_portfolio_plus_portfolio<?php echo $moduleclass_sfx;?> tplVani TzContent">
        ...
        <?php endif?>
        <div id="portfolio<?php echo $module->id; ?>" class="masonry row " style="margin: 0 -<?php echo $tplParams->get('padding'); ?>">
            <?php foreach ($list as $i => $item) : ?>
                ...
                ?>
                <div class="element <?php echo implode(' ', $item_filter).' '.$type?>"
