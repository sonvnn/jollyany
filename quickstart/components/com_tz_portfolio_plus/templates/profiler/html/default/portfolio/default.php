...
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/'.$tzTemplate -> template.'/js/template.js');

$doc -> addScriptDeclaration('profiler('.$this->params.','.$rwidth.','.$rheight.');');
?>
...
<?php if($this -> items):?>
    ...
    $params = &$this -> params;
?>
<div id="tpPortfolio" class="tzpp_bootstrap3 tplProfiler <?php echo $this->pageclass_sfx;?>">
