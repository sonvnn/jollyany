...
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/zalta/js/template.min.js');
$doc -> addScript(TZ_Portfolio_PlusUri::base(true).'/templates/zalta/js/lightbox.min.js');
$doc -> addScriptDeclaration('zalta('.$this->params.','.$rwidth.','.$rheight.', ['.$lightboxopt.']);');
?>
...
<?php if($this -> items):?>
    ...
    $params = &$this -> params;
?>
<div id="tpPortfolio" class="tplzalta tzpp_bootstrap3 <?php echo $this->pageclass_sfx;?>">
