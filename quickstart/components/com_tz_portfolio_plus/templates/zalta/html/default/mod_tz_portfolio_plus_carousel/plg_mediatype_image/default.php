...
?>
    <div class="tz_portfolio_plus_image" style="background-image: url('<?php echo $image -> url;?>');">
        ...
        <div class="iconhover">
            <span class="white-rounded"><a class="popup-item" href="<?php echo $image_url;?>" data-id="lightbox<?php echo $item -> id; ?>" data-type="image" data-thumb="<?php echo $image -> url; ?>"><i class="tps tp-search"></i></a></span>
