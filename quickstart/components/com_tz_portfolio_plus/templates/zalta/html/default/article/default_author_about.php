                    ...
                    <div class="social_link">
                        <?php if($item -> author_info -> twitter):?>
                            <span class="muted tpAuthorInfo SocialLink">
                                <a href="<?php echo $item -> author_info -> twitter; ?>" title="Twitter"><i class="tpb tp-twitter"></i></a>
                            </span>
                        <?php endif;?>
                        <?php if($item -> author_info -> facebook):?>
                            <span class="muted tpAuthorInfo SocialLink">
                                <a href="<?php echo $item -> author_info -> facebook; ?>" title="Facebook"><i class="tpb tp-facebook-f"></i></a>
                            </span>
                        <?php endif;?>
                        <?php if($item -> author_info -> googleplus):?>
                            <span class="muted tpAuthorInfo SocialLink">
                                <a href="<?php echo $item -> author_info -> googleplus; ?>" title="Google Plus"><i class="tpb tp-google-plus-g"></i></a>
                            </span>
                        <?php endif;?>
                        <?php if($item -> author_info -> instagram):?>
                            <span class="muted tpAuthorInfo SocialLink">
                                <a href="<?php echo $item -> author_info -> instagram; ?>" title="Instagram"><i class="tpb tp-instagram"></i></a>
                            </span>
                        <?php endif;?>
                    </div>
                    <?php endif; ?>
