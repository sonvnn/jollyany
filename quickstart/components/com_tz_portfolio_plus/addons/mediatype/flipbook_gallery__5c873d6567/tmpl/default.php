                ...
                <div class="card h-100">
                    ...
                    <ul class="list-unstyled p-2 d-flex flex-column col" id="flipbook_gallery_files">
                        <?php if (isset($flipbook_gallery['data']) && count($flipbook_gallery['data'])) : ?>
                            ...
                            <?php endfor; ?>
                        <?php endif; ?>
                        <li class="text-muted text-center empty"<?php if (count($flipbook_gallery)) echo ' style="display: none;"'; ?>><?php echo JText::_('PLG_MEDIATYPE_FLIPBOOK_GALLERY_NO_FILE_UPLOADED'); ?></li>
                    </ul>
                </div>
            </div>
        </div><!-- /file list -->
