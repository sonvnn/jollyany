                ...
                <div class="card h-100">
                    ...
                    <ul class="list-unstyled p-2 d-flex flex-column col" id="grid_gallery_files">
                        <?php if (isset($grid_gallery['data']) && count($grid_gallery['data'])) : ?>
                            ...
                            <?php endforeach; ?>
                        <?php endif; ?>
                        <li class="text-muted text-center empty"<?php if (count($grid_gallery)) echo ' style="display: none;"'; ?>><?php echo JText::_('PLG_MEDIATYPE_GRID_GALLERY_NO_FILE_UPLOADED'); ?></li>
                    </ul>
                </div>
            </div>
        </div><!-- /file list -->
