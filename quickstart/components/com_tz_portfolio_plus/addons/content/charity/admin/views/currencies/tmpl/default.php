        ...
        <div class="tpContainer">
            ...
            <table class="table table-striped"  id="addonDataList">
                ...
                <tr>
                    ...
                    <th class="nowrap">
                        <?php echo JHtml::_('searchtools.sort','JDEFAULT','value.default',$listDirn,$listOrder);?>
                    </th>
                    <th class="nowrap">
                        <?php echo JHtml::_('searchtools.sort','JGLOBAL_FIELDSET_DISPLAY_OPTIONS','value.display',$listDirn,$listOrder);?>
                    </th>
                    <th width="3%" class="nowrap center">
                        <?php echo JHtml::_('searchtools.sort','Code','value.code',$listDirn,$listOrder);?>
                    </th>
                    <th width="3%" class="nowrap center">
                        <?php echo JHtml::_('searchtools.sort','Sign','value.sign',$listDirn,$listOrder);?>
                    </th>
                ...
                <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $data -> extension_id;?>">
                    ...
                    <td class="center">
                        <div class="btn-group">
                            <?php echo JHtml::_('jgrid.published', $data->published, $i, 'currencies.', $canChange, 'cb'); ?>
                        </div>
                    </td>
                    <td>
                        <?php
                    ...
                    <td width="1%">
                        <?php
                        if (isset($item->default) && ($item->default == '0' || $item->default == '1')):?>
                            <?php echo JHtml::_('jgrid.isdefault', $item->default != 0, $i, 'currencies.', $canChange);?>
                        <?php endif;?>
                    </td>
                    <td width="1%">
