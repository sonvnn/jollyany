...
?>
	...
	<div class="buttons_right">
		<button id="hikabtn_checkout_next" type="submit" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikabtn-success hikabtn_checkout_next" onclick="if(window.checkout.onFormSubmit && !window.checkout.onFormSubmit(this.form)) { return false; } this.form.submit(); this.disabled=true; window.Oby.addClass(this, 'next_button_disabled'); return false;"><?php
